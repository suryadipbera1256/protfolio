...
export const profile = {
  ...
  projects: [
    {
      title_1: 'Lung Cancer Detection using CNN',
      description_1: 'The project "Lung Cancer Detection Using CNN" focuses on developing a deep learning-based approach for early and accurate detection of lung cancer using medical imaging data such as CT scans or X-rays. Early detection is critical for improving survival rates and treatment outcomes.',
      link_1: 'https://github.com/suryadipbera1256/Lung-Cancer-Detection-Using-CNN',

      title_2: 'ToDo App',
      description_2: 'This is a simple ToDo application built using Flask, Flask-SQLAlchemy, and deployed on Heroku using Gunicorn as the WSGI server. The app allows users to create, read, update, and delete tasks, providing a straightforward interface for managing daily tasks.',
      link_2: 'https://github.com/suryadipbera1256/ToDo-Web-App',

      title_3: 'Epileptic-Seizure-Recognition',
