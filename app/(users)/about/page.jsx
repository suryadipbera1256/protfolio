    ...
    <main className="relative z-0 min-h-screen bg-[#050505] text-[#f4f4f5]">
      ...
      <div className="max-w-[85rem] mx-auto px-6 md:px-12 lg:px-16 pt-32 pb-32">
        <div className="grid grid-cols-1 lg:grid-cols-[320px_1fr] gap-12 lg:gap-20 relative">
          ...
          ========================================= */}
          <aside className={`hidden lg:flex flex-col sticky top-32 h-max bg-[#0a0a0a] border border-[#1f1f1f] rounded-[2rem] p-8 shadow-[0_0_30px_rgba(0,0,0,0.5)] transition-all duration-1000 ease-out transform ${isMounted ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-12'}`}>
            
            <div className={`flex flex-col items-center border-b border-[#1f1f1f] pb-8 mb-8 transition-all duration-1000 ease-out delay-200 transform ${isMounted ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-8'}`}>
          ...
          ========================================= */}
          <div className={`lg:hidden flex flex-col items-center bg-[#0a0a0a] border border-[#1f1f1f] rounded-[2rem] p-8 shadow-[0_0_30px_rgba(0,0,0,0.5)] transition-all duration-1000 ease-out transform ${isMounted ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-12'}`}>
            <div className="w-32 h-32 rounded-full overflow-hidden border-2 border-[#1f1f1f] mb-4 shadow-[0_0_20px_rgba(6,182,212,0.15)] group relative">
              <div className="absolute inset-0 z-10 rounded-full border-2 border-transparent group-hover:border-cyan-400 transition-colors duration-700 pointer-events-none"></div>
              <Image src="/PIC/MY PHOTO.jpg" alt="Suryadip Bera" fill className="object-cover transform transition-transform duration-700 group-hover:scale-110" priority />
            </div>
          ...
          <div className="flex flex-col gap-16 lg:gap-24 w-full max-w-4xl">
            ...
            <section id="introduction" className="scroll-mt-32">
              ...
              <div className="flex flex-wrap gap-3 mb-10">
                {/* WRAPPER FIX: Isolates slow entrance delay from lightning-fast hover colors */}
              ...
              <div className={`bg-[#0a0a0a] border border-[#1f1f1f] p-8 md:p-10 rounded-[2rem] shadow-[0_0_20px_rgba(0,0,0,0.5)] transition-all duration-1000 ease-out transform ${visible.introduction ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'}`} style={{ transitionDelay: '500ms' }}>
            ...
            <section id="experience" className="scroll-mt-32">
              ...
              <div className="flex flex-col gap-8">
                ...
                <div className={`bg-[#0a0a0a] border border-[#1f1f1f] transition-all duration-1000 ease-out p-8 md:p-10 rounded-[2rem] shadow-[0_0_20px_rgba(0,0,0,0.5)] overflow-hidden transform ${visible.experience ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'}`} style={{ transitionDelay: '200ms' }}>
                ...
                <div className={`bg-[#0a0a0a] border border-[#1f1f1f] transition-all duration-1000 ease-out p-8 md:p-10 rounded-[2rem] transform ${visible.experience ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'}`} style={{ transitionDelay: '400ms' }}>
            ...
            <section id="skills" className="scroll-mt-32">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className={`bg-[#0a0a0a] border border-[#1f1f1f] p-8 rounded-[2rem] hover:border-[#333] transition-all duration-1000 ease-out transform ${visible.skills ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'}`} style={{ transitionDelay: '100ms' }}>
                  ...
                  <div className="flex flex-wrap gap-3">
                    {skillsData.wellKnown.map((skill, index) => (
                      /* WRAPPER FIX: Isolates slow entrance delay from fast hover */
                      <div key={skill.name} className={`transition-all duration-700 ease-out transform ${visible.skills ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-4'}`} style={{ transitionDelay: `${index * 50 + 300}ms` }}>
                        <span className="flex items-center gap-2 px-3.5 py-1.5 bg-[#141414] border border-[#262626] rounded-xl text-sm font-medium text-[#f4f4f5] hover:border-cyan-400/50 hover:shadow-[0_0_15px_rgba(6,182,212,0.2)] hover:-translate-y-1 transition-all duration-200 shadow-sm cursor-default">
                ...
                <div className={`bg-[#0a0a0a] border border-[#1f1f1f] p-8 rounded-[2rem] hover:border-[#333] transition-all duration-1000 ease-out transform ${visible.skills ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'}`} style={{ transitionDelay: '200ms' }}>
                ...
                <div className={`bg-[#0a0a0a] border border-[#1f1f1f] p-8 rounded-[2rem] hover:border-[#333] transition-all duration-1000 ease-out transform ${visible.skills ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'}`} style={{ transitionDelay: '300ms' }}>
                ...
                <div className={`bg-[#0a0a0a] border border-[#1f1f1f] p-8 rounded-[2rem] hover:border-[#333] transition-all duration-1000 ease-out transform ${visible.skills ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'}`} style={{ transitionDelay: '400ms' }}>
                ...
                <div className={`bg-[#0a0a0a] border border-[#1f1f1f] p-8 rounded-[2rem] hover:border-[#333] transition-all duration-1000 ease-out transform ${visible.skills ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'} md:col-span-2`} style={{ transitionDelay: '500ms' }}>
            ...
            <section id="education" className="scroll-mt-32">
              ...
              <div className="flex flex-col gap-6">
                ...
                <div className={`bg-[#0a0a0a] border border-[#1f1f1f] hover:border-[#333] transition-all duration-1000 ease-out p-8 md:p-10 rounded-[2rem] shadow-[0_0_20px_rgba(0,0,0,0.5)] transform ${visible.education ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'}`} style={{ transitionDelay: '200ms' }}>
                  <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-3 mb-4 border-b border-[#1f1f1f] pb-6">
                    ...
                    <span className="inline-block px-3 py-1 bg-[#141414] border border-[#262626] text-cyan-400 rounded-full text-sm font-bold transition-colors duration-200 hover:border-cyan-400/50 cursor-default">CGPA: 8.25</span>
                  </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  <div className={`bg-[#0a0a0a] border border-[#1f1f1f] p-6 rounded-[2rem] transition-all duration-1000 ease-out transform ${visible.education ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'}`} style={{ transitionDelay: '300ms' }}>
                    <div className="flex justify-between items-center mb-2">
                      <h3 className="text-lg font-bold text-[#f4f4f5]">12th Grade (WBCHSE)</h3>
                      <span className="text-[#888888] text-sm">2021</span>
                    </div>
                    <span className="inline-block mt-2 px-3 py-1 bg-[#141414] border border-[#262626] text-cyan-400 rounded-lg text-sm font-bold shadow-sm transition-colors duration-200 hover:border-cyan-400/50 cursor-default">Score: 77.2%</span>
                  </div>

                  <div className={`bg-[#0a0a0a] border border-[#1f1f1f] p-6 rounded-[2rem] transition-all duration-1000 ease-out transform ${visible.education ? 'opacity-100 translate-y-0' : 'opacity-0 translate-y-12'}`} style={{ transitionDelay: '400ms' }}>
                    <div className="flex justify-between items-center mb-2">
                      <h3 className="text-lg font-bold text-[#f4f4f5]">10th Grade (WBBSE)</h3>
                      <span className="text-[#888888] text-sm">2019</span>
                    </div>
                    <span className="inline-block mt-2 px-3 py-1 bg-[#141414] border border-[#262626] text-cyan-400 rounded-lg text-sm font-bold shadow-sm transition-colors duration-200 hover:border-cyan-400/50 cursor-default">Score: 84.2%</span>
                  </div>
                </div>
